...
namespace Anthem.Items.Buff
{
    public class Heavenbound : ModBuff
    {
        public override void SetStaticDefaults()
        {
            ...
            Description.SetDefault("Jessie blesses you. 20% more movement speed, weapon use time and defense");
        ...
        public override void Update(Player player, ref int buffIndex)
        {
            ...
            player.GetAttackSpeed(DamageClass.Generic) += 0.2f; // 20% increased weapon use time
